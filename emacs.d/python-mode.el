...
(if py-mode-map
  ...
  ;; DJH change:(define-key py-mode-map "\C-c\C-r"     'py-shift-region-right)
  ...
  ;; DJH change: (define-key py-mode-map "\C-c|"  'py-execute-region)
...
;;      (msg (format "## working on region in file %s...\n" filename))
        (msg (get-string-from-file filename))
